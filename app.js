...
*/
game.party.push(pokemon[148],pokemon[149],pokemon[129])
...
*/
game.party.forEach((partyMember) => {
    console.log("exercise 8", partyMember.name);
});
/*
Exercise 9
...
pokemon.forEach((pokemonObject ) => {
  if(pokemonObject.starter===true)
    starterPokemon.push(pokemonObject.name)
});
...
function gymStatus (){
  ...
  console.log(`exercise 13` ,completedGyms);
  console.log(`exercise 13`, incompletedGyms);
}
